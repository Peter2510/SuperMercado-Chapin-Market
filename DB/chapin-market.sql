...
VALUES
  ('Arroz integral', 'Arroz integral de alta calidad', 5.25),
  ('Aceite de Oliva Virgen Extra', 'Aceite de oliva premium', 7),
  ('Lentejas', 'Lentejas secas de granja', 3.56),
  ('Salmón fresco', 'Filetes de salmón fresco', 59.99),
  ('Cereales de desayuno', 'Cereales de desayuno variados', 2.99),
  ('Pasta de trigo integral', 'Pasta de trigo integral', 12.86),
  ('Leche orgánica', 'Leche orgánica de vacas felices', 3.49),
  ('Horno de microondas Panasonic', 'Horno de microondas con múltiples funciones', 1449.50),
  ...
  ('Cafetera Nespresso', 'Cafetera de cápsulas con espumador de leche', 199.99),
  ('Yogur griego', 'Yogur griego natural sin azúcar', 2.79),
  ('Café molido', 'Café molido de origen colombiano', 8.49),
  ('Zanahorias', 'Zanahorias orgánicas', 2.29),
  ('Papas', 'Papas frescas cultivadas localmente', 1.99),
  ('Pan integral', 'Pan integral recién horneado', 3.29),
  ('Huevos orgánicos', 'Huevos orgánicos de gallinas libres', 4.99),
  ...
  ('Caja de herramientas Craftsman', 'Caja de herramientas con múltiples compartimentos', 129.75),
  ('Bicicleta de montaña Trek', 'Bicicleta de montaña con suspensión total', 699.99),
  ('Monopatín eléctrico Razor', 'Monopatín eléctrico con motor de alta potencia', 299.25),
  ('Juego de maletas Samsonite', 'Juego de maletas con ruedas giratorias', 199.99),
  ('Té verde', 'Té verde de calidad premium', 3.79),
  ...
  ('Altavoces Bluetooth Bose', 'Altavoces Bluetooth portátiles de alta calidad', 149.75),
  ('Auriculares inalámbricos Sony', 'Auriculares inalámbricos con cancelación de ruido', 199.00),
  ('Impresora Epson', 'Impresora de inyección de tinta de alto rendimiento', 119.99),
  ('Mesa de comedor moderna', 'Mesa de comedor de diseño contemporáneo', 499.00),
  ('Cereal de avena', 'Cereal de avena orgánica', 44.49),
  ...
  ('Cortadora de césped Honda', 'Cortadora de césped autopropulsada de gas', 349.99),
  ('Barbacoa Weber', 'Barbacoa de carbón con superficie de cocción grande', 199.00),
  ('Tienda de campaña Coleman', 'Tienda de campaña para 4 personas', 89.99),
  ('Tofu', 'Tofu orgánico para platos vegetarianos', 30.99),
  ('Aceitunas', 'Aceitunas rellenas de pimiento', 21.99),
  ('Mantequilla de maní', 'Mantequilla de maní natural', 15.49),
  ('Yogur de vainilla', 'Yogur de vainilla con frutas', 22.79),
  ('Uvas', 'Uvas rojas y verdes', 3.49),
  ('Pan multigrano', 'Pan multigrano recién horneado', 23.99),
  ('Café descafeinado', 'Café descafeinado de alta calidad', 6.00),
  ...
  ('Robot de cocina KitchenAid', 'Robot de cocina con múltiples accesorios', 349.99),
  ...
  ('Secadora LG', 'Secadora de ropa con tecnología de secado rápido', 499.99),
  ('Tostadora Cuisinart', 'Tostadora de 4 rebanadas con funciones de descongelado', 39.99),
  ('Smartphone Samsung Galaxy', 'Smartphone con pantalla OLED y cámara de alta resolución', 699.75),
  ('Portátil HP', 'Portátil con procesador de última generación', 799.99),
  ...
  ('Cámara Canon DSLR', 'Cámara réflex digital con lentes intercambiables', 599.75),
  ('Reproductor de Blu-ray LG', 'Reproductor de Blu-ray con streaming en línea', 69.25),
  ('Sofá seccional de cuero', 'Sofá seccional de cuero genuino', 899.99),
  ('Silla de oficina ergonómica', 'Silla de oficina ajustable con soporte lumbar', 199.25),
  ('Mesa de centro de vidrio', 'Mesa de centro de vidrio templado con base metálica', 299.25),
  ('Lámpara de pie LED', 'Lámpara de pie LED regulable en intensidad', 79.99),
  ...
  ('Tobogán de agua Little Tikes', 'Tobogán de agua para niños', 79.99),
  ('Caja de bloques LEGO', 'Caja de bloques de construcción creativos', 49.25),
  ('Pelota de fútbol Adidas', 'Pelota de fútbol oficial de la Copa del Mundo', 19.45),
  ('Bicicleta estática NordicTrack', 'Bicicleta estática con pantalla táctil', 349.99),
  ('Patinete eléctrico Xiaomi', 'Patinete eléctrico plegable con frenos de disco', 399.85),
  ('Cereal de maíz', 'Cereal de maíz crujiente', 52.29),
  ('Leche de almendras', 'Leche de almendras sin azúcar', 24.90),
  ('Brócoli', 'Brócoli fresco y saludable', 2.79),
  ...
  ('Casco de bicicleta Giro', 'Casco de bicicleta con tecnología de protección avanzada', 59.20),
  ...
  ('Set de herramientas de jardín', 'Set de herramientas de jardín de alta calidad', 519.35),
  ...
  ('Colchón de espuma viscoelástica', 'Colchón de espuma viscoelástica con soporte lumbar', 12.5);
